...
const survey: SurveyDict = {
  ...
  hashMismatchTitle: 'Content integrity warning',
  hashMismatchDesc: 'The loaded survey content does not match the hash registered on-chain. It may have been tampered with, or the content source (RPC / storage node) is faulty. Please proceed with caution.',
  hashMismatchContinue: 'Continue anyway',
  ...
  errQuestionRequired: (prompt: string) => `Question "${prompt}" is required.`,
  errInvalidOption: (prompt: string) => `Question "${prompt}" submitted an invalid option value.`,
  errMultiChoiceFormat: (prompt: string) => `The answer format for multi-choice question "${prompt}" is invalid.`,
