...
const dashboard: DashboardDict = {
  ...
  closeWarning: (days: number) => `After closing, a ${days}-day grace period begins; once it elapses every response and question for this survey is permanently destroyed and cannot be recovered.`,
  ...
  btnPurge: 'Delete survey permanently',
  purgeConfirm: 'This immediately and permanently destroys all responses and questions for this survey and cannot be undone. Delete it?',
