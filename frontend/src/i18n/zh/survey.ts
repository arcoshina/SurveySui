const survey = {
  ...
  gasVaultEmptyConfirmTitle: '此問卷的 Gas 代付池已用罄',
  gasVaultEmptyConfirmDesc: (estSui: string) => `此問卷由發起者預存的 Gas 代付池已用罄。如欲領獎，需由您自付鏈上手續費 (預估 ${estSui} SUI)。是否繼續?`,
  gasVaultEmptyWarning: '此問卷的 Gas 代付池已用罄，如欲領獎請自付 Gas 提交',
  ...
  errInlineAnswerTooLarge: '答卷內容過長，超過鏈上單筆上限。請精簡內容；若需附大型檔案，請改以雲端硬碟連結貼於答案中。',
